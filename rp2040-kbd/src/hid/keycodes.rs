...
impl KeyCode {
    ...
    pub const TAB: Self = Self(0x2B); //Tab Sel 16 3 3 3 4/101/104
    ...
    pub const QUOTE: Self = Self(0x34); //‘ and “2 Sel 41 3 3 3 4/101/104
    ...
    pub const F12: Self = Self(0x45); //F12 Sel 123 3 3 3 4/101/104
    pub const PRINT_SCREEN: Self = Self(0x46); //PrintScreen7 Sel 124 3 3 3 4/101/104
    ...
    pub const INSERT: Self = Self(0x49); //Insert7 Sel 75 3 3 3 4/101/104
    pub const HOME: Self = Self(0x4A); //Home7 Sel 80 3 3 3 4/101/104
    pub const PAGE_UP: Self = Self(0x4B); //PageUp7 Sel 85 3 3 3 4/101/104
    pub const KC_DELF: Self = Self(0x4C); //Delete Forward7,8 Sel 76 3 3 3 4/101/104
    pub const END: Self = Self(0x4D); //End7 Sel 81 3 3 3 4/101/104
    pub const PAGE_DOWN: Self = Self(0x4E); //PageDown7 Sel 86 3 3 3 4/101/104
    ...
    pub const PIPE: Self = Self(0xC9); //| Sel
