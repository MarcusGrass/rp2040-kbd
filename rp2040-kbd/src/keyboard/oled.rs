...
impl OledHandle {
    pub fn new(mut display: Ssd1306<I2CInterface<rp2040_hal::I2C<I2C1, (rp2040_hal::gpio::Pin<Gpio2, FunctionI2c, PullDown>, rp2040_hal::gpio::Pin<Gpio3, FunctionI2c, PullDown>)>>, DisplaySize128x32, BufferedGraphicsMode<DisplaySize128x32>>) -> Self {
    ...
    pub fn clear_line(&mut self, l: i32) -> bool {
        if self.display.fill_solid(&Rectangle {
            top_left: Point::new(0, l),
            size: Size::new(32, 9),
        }, BinaryColor::Off).is_ok() {
