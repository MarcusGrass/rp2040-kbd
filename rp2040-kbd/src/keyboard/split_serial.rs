...
impl UartLeft {
    pub fn new(
        uart_pin: Pin<Gpio1, FunctionNull, PullDown>,
        baud: fugit::HertzU32,
...
impl UartRight {
    pub fn new(
        ...
        let mut tx_program = pio_uart::install_tx_program(&mut inner_pio).ok().unwrap(); // Should never fail, because no program was loaded yet
